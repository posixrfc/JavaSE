...
{
    /**
     * 根据文件后缀名获取响应的 mime-type
     * ini, properties, sln, xcodeproj, socket, sys, config, gradle, mk, md, yml, h, m, mm, cs, ipa, aar, obj
     * etc, all not standardized aways return application/octet-stream
     * @param suffix 文件后缀名，不区分大小写
     * @return 返回的mime-type字符串，始终是有效值
     */
    public static String getMimeTyeOfSuffix(final String suffix)
    {
